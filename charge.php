...
<html lang="en">
  ...
  //Get total from db
  $query = "SELECT distinct sum(price * quantity) as total_price, uc.user_id
  FROM user u inner join user_cart uc
...
$filename = "Database/userReceipt.txt";
$content = "\n\nCustomer: " . $_SESSION['fname'] . 
            "\nEmail: " . $customer['email'];


  file_put_contents($filename, $content, FILE_APPEND | LOCK_EX);
  //Remove from cart and add to order history
